...
def loading_screen():
    for i in range(10):
        ...
        sys.stdout.flush()
        time.sleep(0.5)
    sys.stdout.write("\rLoading is complete!")
...
def grade(num):
    if num>=90:
        ...
        return("Performance: BELOW AVERAGE. \nStatus: PASSED. \nGrade: E. \nRemarks: There is massive scope of improvement.")
    else:
...
while message:
    ...
    with open(f'{path}/Department.csv','a',newline='')as f:
        ...
        script.writerow(['CSEIOTCSBT','Computer Science and Engineering and Internet of things, cybersecurity including blockchain technology'])
...
print('\n','Computer Science and Engineering : CSE','\n',
      ...
      'Computer Science and Engineering and Internet of things, cybersecurity including blockchain technology : CSEIOTCSBT','\n',
      'Information Technology : IT','\n',
      'Electronics and Communications Engineering : ECE','\n',
      'Mechanical Engineering : ME','\n')
print("Please write all the stream name in short form as mentioned above IN CAPITAL LETTERS.")
print()
...
for i in range(student_no):
    ...
    if duplicate('Student.csv',student_id,0):
        print("Student is already present in the directory.")
        print(f"You can find your report card here : {path}/ReportCards/{student_id}_{name}.txt")
    else:
        print()
        print("The subjects are [Math, Physics, Chemistry, Biology, English, Python]")
        print('Enter the subjects marks in the above mentioned order in a list type and if you dont have a particular subject write "null" (e.g. [100,100,"null",75,69,85])')
        print('Each Subject is out of 100 marks')
        print()
        marks_lst=eval(input("Enter the Mark list : "))
...
while True:
    if batch_id in batch:
        ...
        if ask.lower()=='y':
            ...
            break
print()
print('The overall Course graph is going to come shortly')
print('Please Close the Figure window after viewing to continue')
loading_screen()
course_graph()
print()
print()
print("The overall Department wise average graph is going to come shortly")
print('Please Close the Figure window after viewing to continue')
loading_screen()
department_graph()
print()
